...
const SideBar = ({ userLoggedIn, sideBarOpen, setSideBarOpen }) => {
  return (
    <div
      id="sideBar"
      className={`duration-400 fixed left-0 top-0 z-10 flex h-screen w-2/3 transform bg-gray-50 transition-transform ease-in-out sm:hidden dark:bg-dark ${sideBarOpen
