...
//     <div
//       id="sideBar"
//       className={`sm:hidden h-screen pb-2 fixed overflow-auto flex flex-col w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 xl:w-1/6 2xl:w-1/6  bg-gray-50 dark:bg-darkColor  z-10 left-0 top-0  transform transition-transform duration-400 ease-in-out ${
//         sideBarOpen
...
//         <CloseIcon
//           className="absolute right-1 top-1 text-gray-600 cursor-pointer dark:hover:text-darkColor-text hover:text-gray-800 p-0.5"
//           fontSize="small"
//         />
//         {userLoggedIn ? (
//           <div className="flex items-center gap-3 justify-start px-2   border-b">
//             <DarkModeBtn />
//             <div
//               onClick={() => navigate("/")}
//               className="cursor-pointer flex pt-1 "
//             >
...
//             {userLoggedIn && (
//               <div className="text-center  w-full bottom-4 border-t">
//                 <button
//                   onClick={handleLogout}
//                   className="cursor-pointe text-gray-800 hover:text-gray-600"
//                 >
//                   <LogoutIcon fontSize="small" className="pb-1" />
//                   Logout
//                 </button>
//               </div>
//             )}
