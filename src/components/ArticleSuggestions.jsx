...
const ArticleSuggestions = () => {
  return (
    <div className="inner-div pb-10 pt-4">
      <div className="p-4 px-8 text-center text-xl font-bold tracking-wide text-brand sm:text-2xl md:px-10 lg:text-2xl xl:px-20 dark:text-dark">
        Find the perfect job for{" "}
        <span className="uppercase text-brand-dark dark:text-brand">you</span>
      </div>
