...
async function handleSubmit(e) {
  ...
  return (
    <div className='flex flex-col items-center justify-center p-10 pt-20'>
        ...
        <div>
            <form onSubmit={handleSubmit} className='flex flex-col gap-2 border border-brandColor rounded-sm p-4 mt-4'>
                <div className='flex flex-col gap-1'><label htmlFor="newPassword" className='text-sm'>Enter new password</label>
                <input type="text" id='newPassword' name='newPassword' onChange={handleChange} value={formData.newPassword} className='inputStyle' required/></div>
                <div className='flex flex-col gap-1'><label htmlFor="ConfirmNewPassword" className='text-sm'>Confirm new password</label>
                <input type="text" id='ConfirmNewPassword' name='ConfirmNewPassword' onChange={handleChange} value={formData.ConfirmNewPassword} className='inputStyle' required/></div>
